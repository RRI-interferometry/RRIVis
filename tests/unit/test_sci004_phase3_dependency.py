...
def authenticate_source_design_bindings() -> str:
    """Authenticate current D36 and historical D32/D33/D34/D35 without changing R resolution."""
    ...
    if (
        ...
        != (
            ...
            phase_history.HISTORICAL_D35_SOURCE_DESIGN_SHA,
...
def test_source_design_bindings_reject_false_roles_and_authentication(
    ...
    elif mutation == "stale_d35":
        monkeypatch.setattr(
            module, "SOURCE_DESIGN_SHA", HISTORICAL_D35_SOURCE_DESIGN_SHA
        )
    elif mutation == "d35_is_current":
        monkeypatch.setattr(
            module, "HISTORICAL_D35_SOURCE_DESIGN_SHA", SOURCE_DESIGN_SHA
        )
...
def test_source_design_bindings_require_original_first_parent_ancestry(
    ...
    elif attack == "before_d36":
        bad = HISTORICAL_D35_SOURCE_DESIGN_SHA
    else:
        bad = commit(
            base,
