...
centre values match their initial-stream projections bitwise. Full terminal
semantic validation, authenticated historical terminal reconstruction, a reviewed
numerical transition relation and observation admission remain pending.
