...
unions and one outward conversion, preserving every budget. A prospective
operative grant, source correction, certificate conformity and numerical
transition/admission remain required; no retained certificate is rewritten.
