...
unions and one outward conversion, preserving every budget. D35 now provides the reviewed operative grant at `dd26e04`. Source correction,
strict executable activation, certificate conformity and numerical transition/
admission remain required; no retained certificate is rewritten.
