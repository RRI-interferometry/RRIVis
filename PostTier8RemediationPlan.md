...
| WP-9 | Design gate ACCEPTED 2026-08-21: candidate `978fef6` received its two required fresh independent Phase-0 reviews (physics/governance + computational, staleness mandate; both REJECT with bounded findings), one combined bounded correction was dual-ACCEPTed on pinned bytes/diff (recorded in the design header) and landed 2026-08-21; a second dated bounded correction (R1-authoring reconciliation, dual-ACCEPTed 2026-08-22, recorded in the design header with its supersession citation) now holds the operative `D` per the design's §13.7; production remains phase-gated (M1 on the frozen-descendant WP-7 replay gate, M3 on the accepted SCI-005 Stage-2 certificate); SCI-004 remains ROADMAP |
