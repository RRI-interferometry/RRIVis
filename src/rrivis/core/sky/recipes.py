# rrivis/core/sky/recipes.py
"""High-level sky-model recipes that compose the RRIVis primitives into
...
canonical three-layer low-frequency foreground described in the RRIVis
...
def realistic_foreground_sky(
    *,
    ...
    if confusion_flux_range_jy is not None:
        ...
        from ._loaders_synthetic import load_poisson_confusion
