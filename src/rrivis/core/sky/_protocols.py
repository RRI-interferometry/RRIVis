...
importing the concrete :class:`rrivis.core.sky.model.SkyModel` class.
...
if TYPE_CHECKING:
    from ._data import HealpixData, PointSourceData, SkyProvenance
