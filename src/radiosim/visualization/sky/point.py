"""Point-source sky plots — module-level functions."""
...
def plot_source_positions(
    ...
    _validate_plot_mode(sky, "point_sources")

    values, cbar_label = _get_color_data(sky, color_by)
    ...
    point = sky.point
    lon, lat = _rotate_coords(point.ra_rad, point.dec_rad, coord)
    ...
    return _scatter_sky(
        ...
        coord=coord,
        title=title if title is not None else _auto_title(sky, "Source Positions"),
        figsize=figsize,
    )
...
def plot_flux_histogram(
    ...
    ax.set_title(title if title is not None else _auto_title(sky, "Flux Distribution"))
    return fig
...
def plot_spectral_index(
    ...
    _validate_plot_mode(sky, "point_sources")
    alpha_arr = sky.point.spectral_index
    ...
    if plot_type == "histogram":
        ...
        ax.set_title(
            ...
            else _auto_title(sky, "Spectral Index Distribution")
        )
        return fig
    ...
    if plot_type == "sky_map":
        ...
        return _scatter_sky(
            ...
            title=title
            if title is not None
            else _auto_title(sky, "Spectral Index Sky Map"),
            figsize=figsize,
        )
