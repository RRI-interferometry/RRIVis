...
from radiosim.core.jones.beam import BeamJones
...
class AnalyticBeamJones(BeamJones):
    ...
    def plot(
        ...
        **kwargs: Any,
        ...
        :func:`~radiosim.core.jones.beam.analytic.plotting.plot_beam_pattern`
...
from radiosim.core.jones.beam.analytic.plotting import (  # noqa: E402
    plot_beam_2d,
