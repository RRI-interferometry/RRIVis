...
Examples
--------
>>> from radiosim.core.jones.beam.analytic.plotting import plot_beam_pattern
>>> fig = plot_beam_pattern(diameter=14.0, frequency=150e6, taper="gaussian")

>>> from radiosim.core.jones.beam.analytic.plotting import plot_beam_comparison
...
def plot_beam_pattern(
    ...
    :func:`~radiosim.core.jones.beam.analytic.composed.compute_aperture_beam`,
    ...
    if show_hpbw:
        ...
        from radiosim.core.jones.beam.analytic.taper import TAPER_FUNCTIONS
...
def plot_feed_illumination(
    ...
    Uses :func:`~radiosim.core.jones.beam.analytic.feed.feed_to_taper` to
