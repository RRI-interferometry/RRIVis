# radiosim/core/jones/beam/analytic/composed.py
...
def compute_aperture_beam(
    ...
    """
    from radiosim.core.jones.beam.analytic.aperture import compute_u_beam
    ...
    if feed_model != "none" and feed_computation == "numerical":
        ...
        from radiosim.core.jones.beam.analytic.aperture import sinc_voltage_pattern
