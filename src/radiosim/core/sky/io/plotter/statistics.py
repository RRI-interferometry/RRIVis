"""Statistical HEALPix cube plots — module-level functions."""
...
def plot_pixel_histogram(
    ...
    ax.set_title(
        ...
        else _auto_title(sky, f"Pixel PDF (Stokes {stokes})", freq)
    )
...
def plot_variance_spectrum(
    ...
    fig.suptitle(
        title
        if title is not None
        else _auto_title(sky, f"Variance / Mean / CV — Stokes {stokes}"),
        fontsize=14,
        y=1.02,
    )
...
def plot_frequency_spectra(
    ...
    fig.suptitle(
        title
        if title is not None
        else _auto_title(sky, f"Frequency spectra — Stokes {stokes}"),
        fontsize=14,
        y=1.02,
    )
...
def plot_frequency_waterfall(
    ...
    fig.suptitle(
        title
        if title is not None
        else _auto_title(sky, f"Frequency waterfall — Stokes {stokes}"),
        fontsize=14,
        y=1.02,
    )
