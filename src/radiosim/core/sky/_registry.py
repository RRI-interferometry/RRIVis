...
_DEFAULT_LOADER_MODULES = (
    "radiosim.core.sky._loaders_bbs",
    "radiosim.core.sky._loaders_diffuse",
    "radiosim.core.sky._loaders_fits",
    "radiosim.core.sky._loaders_pyradiosky",
    "radiosim.core.sky._loaders_skyh5_multifile",
    "radiosim.core.sky._loaders_synthetic",
    "radiosim.core.sky._loaders_vizier",
    "radiosim.core.sky.recipes",
)
