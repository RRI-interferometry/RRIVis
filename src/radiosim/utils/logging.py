"""Logging utilities for RadioSim.
...
console = Console(theme=RADIOSIM_THEME)
...
def setup_logging(
    ...
    """
    Set up logging configuration for RadioSim with rich console output.
...
def get_logger(name: str) -> logging.Logger:
    ...
    Args:
        name: Module name (e.g., "radiosim.core.visibility")
